...
void scan_I2C_addresses(void) {
	...
	for (address = 1; address < 128; address++) { // Alamat 0x00 hingga 0x7F
		uint8_t i2c_address = address << 1; // I2C menggunakan format 7-bit
		result = HAL_I2C_IsDeviceReady(&hi2c2, i2c_address, 1, 10);
